...
//    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO.INSTANCE.loadDB();
        searchIn = new HashMap<>();
        searchIn.put("id", "Mã Sinh viên");
        searchIn.put("name", "Tên Sinh Viên");
        searchIn.put("gender", "Giới Tính");
        searchIn.put("departId", "Mã Khoa");
        searchIn.put("gpa", "Điểm trung bình");
        String[] searchIn = {"id", "name", "gender", "departId", "gpa"};
        request.setAttribute("dao", searchIn);
    ...
    HashMap<String, String> searchIn;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Vector<String> listCheck = new Vector<>();
        ...
        if (listCheck.isEmpty()) {
            ...
            String s = "";
            for (String list : listCheck) {
                s += "[" + list + "]" + " like CONCAT('%',?,'%') or ";
            }
